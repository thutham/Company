...
update company infor with new account
    ...
    ${result1}=    Run Keyword And Return Status   Page Should Contain Element    xpath://*[@id="edit-company-profile"]/div/div[3]/form/div[6]/div/div/div/div[2]/div[1]
    run keyword if  ${result1} is ${True}
    ...    Run Keywords
    ...    click element    xpath://*[@id="edit-company-profile"]/div/div[3]/form/div[6]/div/div/div/div[2]/div[1]
    ...    AND  click element   css:.input-group:nth-child(6) .css-1pcexqc-container
    ...    AND  click element   id:react-select-3-option-0
    ...    ELSE    run keywords
    ...    click element   css:.input-group:nth-child(6) .css-1pcexqc-container
    ...    AND  click element   id:react-select-3-option-0

    click element   css:.modal-content
     ${result2}=    Run Keyword And Return Status   Page Should Contain Element    xpath://*[@id="edit-company-profile"]/div/div[3]/form/div[7]/div/div/div/div[2]/div[1]
    run keyword if  ${result2} is ${True}
    ...    Run Keywords
    ...    click element    xpath://*[@id="edit-company-profile"]/div/div[3]/form/div[7]/div/div/div/div[2]/div[1]
    ...    AND  click element   css:.input-group:nth-child(7) .css-1pcexqc-container
    ...    AND  click element   id:react-select-4-option-0
    ...    ELSE    run keywords
    ...    click element   css:.input-group:nth-child(6) .css-1pcexqc-container
    ...    AND  click element   id:react-select-4-option-0
    sleep   2
